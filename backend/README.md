...
## Project Structure
    ...
    ├── mithileshapstaging__93355  # Django project configurations
...
1. Clone this repo and `cd mithileshapstaging__93355`
...
2. Clone this repo and `cd mithileshapstaging__93355`
